...
from models.toy import MNISTToyModel
...
parser.add_argument('-g', '--gradient-weight', type=float)
...
# training
trainer = pl.Trainer(max_epochs=20, precision=32, limit_train_batches=0.5)
